...
public final class GUISpriteSheet {
    ...
    public enum Resources implements SpriteResource {
        ...
        HERO_UNITFRAME_FOCUSBAR_PROGRESS_START(new Region(33, 0, 3, 10)),
        HERO_UNITFRAME_FOCUSBAR_PROGRESS_MIDDLE(new Region(37, 0, 18, 10)),
        HERO_UNITFRAME_FOCUSBAR_PROGRESS_PARTIAL_CAP(new Region(56, 0, 4, 10)),
        HERO_UNITFRAME_FOCUSBAR_PROGRESS_FULL_CAP(new Region(61, 0, 3, 10)),


        HERO_UNITFRAME_ENERGYBAR_PROGRESS_START(new Region(65, 0, 3, 10)),
        HERO_UNITFRAME_ENERGYBAR_PROGRESS_MIDDLE(new Region(69, 0, 18, 10)),
        HERO_UNITFRAME_ENERGYBAR_PROGRESS_PARTIAL_CAP(new Region(88, 0, 4, 10)),
        HERO_UNITFRAME_ENERGYBAR_PROGRESS_FULL_CAP(new Region(94, 0, 3, 10)),

        HERO_UNITFRAME_SPIRITBAR_PROGRESS_START(new Region(97, 0, 3, 10)),
        HERO_UNITFRAME_SPIRITBAR_PROGRESS_MIDDLE(new Region(101, 0, 18, 10)),
