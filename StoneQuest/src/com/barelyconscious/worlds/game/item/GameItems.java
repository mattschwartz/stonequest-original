...
public enum GameItems {
    WILLOW_BARK(0, 1, "Willow Bark", "Bark from the willow tree. Has minimal healing properties.",
        new Resources.Sprite_Resource("items::herbs_bundle"),
    ...
    CURED_LEATHER(1, 1,
        ...
        new Resources.Sprite_Resource("items::cured_leather"),
    ...
    IRON_ORE(2, 1,
        ...
        new Resources.Sprite_Resource("items::hematite_ore"),
