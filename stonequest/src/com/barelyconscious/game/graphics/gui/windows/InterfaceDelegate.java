...
public class InterfaceDelegate {
    ...
    private final static InterfaceDelegate INSTANCE = new InterfaceDelegate();
    ...
    public void init(int gameWidth, int gameHeight) {
        ...
        upgradeItemWindow = new UpgradeItemWindow(artworkWindow.getX(), artworkWindow.getY(), artworkWindow.getUpgradeItemButtonOffsX(), artworkWindow.getUpgradeItemButtonOffsY());
        inventoryWindow = new InventoryWindow(gameWidth, artworkWindow.getY(), artworkWindow.getInventoryButtonOffsX(), artworkWindow.getInventoryButtonOffsY());
        characterWindow = new CharacterWindow(gameWidth, artworkWindow.getY(), artworkWindow.getCharacterButtonOffsX(), artworkWindow.getCharacterButtonOffsY());
        brewingWindow = new BrewingWindow(gameWidth, artworkWindow.getY(), artworkWindow.getBrewingButtonOffsX(), artworkWindow.getBrewingButtonOffsY());
        journalWindow = new JournalWindow(artworkWindow.getX(), artworkWindow.getY(), artworkWindow.getJournalButtonOffsX(), artworkWindow.getJournalButtonOffsY());
        salvageWindow = new SalvageWindow(artworkWindow.getSalvageButtonOffsX(), artworkWindow.getSalvageButtonOffsY());
        textLog = new TextLog(artworkWindow.getTextLogOffsX(), artworkWindow.getTextLogOffsY(), artworkWindow.getTextLogWidth(), artworkWindow.getTextLogHeight());

        Game.screen.addForegroundComponent(textLog);
    ...
    public void resize(int newWidth, int newHeight) {
        ...
        textLog.resize(artworkWindow.getTextLogOffsX(), artworkWindow.getTextLogOffsY(), artworkWindow.getTextLogWidth(), artworkWindow.getTextLogHeight());
    } // resize
