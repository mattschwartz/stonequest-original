...
public class Tile {
    ...
    public static final int LOOT_TILE_ID = 41;
    public static final int TREE_STUMP_TILE_ID = 42;
    // World tiles
    ...
    public void renderFaster(Screen scr, int xStart, int yStart) {
        Graphics2D g = scr.getGraphics();
        
        g.drawImage(null, null, xStart, yStart);
    }
