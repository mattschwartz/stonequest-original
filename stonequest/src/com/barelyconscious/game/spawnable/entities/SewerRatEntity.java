...
public class SewerRatEntity extends Entity {
    ...
    public static final UIElement SEWER_RAT_ENTITY = new UIElement("/gfx/tiles/sprites/entities/sewerRatIcon.png");
    ...
    public void interact(Sprite interactee) {
        ...
        System.out.println(getName() + " deals " + String.format("%.1f", hit) + " damage (" + damageType + ").");
