...
public class Condition {
    ...
    private static final UIElement POTION_CONDITION_ICON = new UIElement("/gfx/conditions/benefits/potions/defaultPotionIcon.png");
    private static final UIElement AURA_CONDITION_ICON = new UIElement("/gfx/conditions/benefits/auras/defaultAuraIcon.png");
    private static final UIElement CURSE_CONDITION_ICON = new UIElement("/gfx/conditions/detriments/curses/defaultCurseIcon.png");
    private static final UIElement TOXIN_CONDITION_ICON = new UIElement("/gfx/conditions/detriments/toxins/defaultToxinIcon.png");
