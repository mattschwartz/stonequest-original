...
public class Screen extends Canvas {
    ...
    private final List<Components> componentsBackground = new ArrayList<Components>();
    private final List<Components> componentsForeground = new ArrayList<Components>();
    private final List<Components> componentsAlwaysOnTop = new ArrayList<Components>();
