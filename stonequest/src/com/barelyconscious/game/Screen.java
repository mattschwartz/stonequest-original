/**
 * ***************************************************************************
 * Project: Roguelike2.0 File name: Screen.java Author: Matt Schwartz Date
 * created: 07.01.2012 Redistribution: You are free to use, reuse, and edit any
 ...
 * issues or concerns. File description: Maintains the pixel array of the
 * current screen image. There may only be one Screen per instance of this game.
 * - int width: the width of the image to be drawn to the screen. This should
 * also be the width of the game window - int height: the height of the image to
 * be drawn to the scren. This should also be the height of the game window -
 * int[] pixels: the pixel data for the image - BufferedImage view: this is what
 * is drawn to the screen. Individual pixels are changed in order to produce an
 * actual game.
 * ***************************************************************************
 */
...
public class Screen extends Canvas {
    ...
    private List<Components> componentsBackground = new ArrayList<Components>();
    private List<Components> componentsForeground = new ArrayList<Components>();
    private List<Components> componentsAlwaysOnTop = new ArrayList<Components>();
...
//        testanimation();
    ...
    public void saveScreenshot() {
        ...
        String date;
        File file = new File(System.getProperty("user.home") + "\\Documents\\barelyconscious\\StoneQuest\\screenshots\\");
        Robot robot;
...
//                setPixel(color, xStart, yStart + i);
//            }
//
//            return;
//        }
...
//        } // for
    ...
    public void addBackgroundComponent(Components c) {
        componentsBackground.add(c);
    } // addBackgroundComponent

    public void addForegroundComponent(Components c) {
        componentsForeground.add(c);
    } // addForegroundComponent

    public void addAlwaysOnTopComponent(Components c) {
...
//        animation();
        ...
        Font.drawFont(this, "Frame time: " + (Game.frametime / 1000000) + "ms", Color.white, false, 0, Font.NEW_CHAR_HEIGHT);
        Font.drawFont(this, "fps: " + Game.frames2, Color.white, false, 0, Font.NEW_CHAR_HEIGHT * 2);
        Font.drawFont(this, "window size: " + width + " x " + height, Color.white, false, 0, Font.NEW_CHAR_HEIGHT * 3);
